...
d3.select("#layout").style("height", "97vh").style("width", "100%");
...
function selectFunction() {
  ...
  for (var a = 0; a < arguments.length; a++) {
    var recid =
      typeof arguments[a] == "object" ? arguments[a].recid : arguments[a];
    ...
    if (
      ...
      (index + 1 >= this.last.range_start && index + 1 <= this.last.range_end)
    ) {
    ...
    if (recEl1 && recEl2) {
      recEl1
        ...
        .data("selected", "yes")
        .find(".w2ui-col-number")
        .addClass("w2ui-row-selected");
      recEl2
        .addClass("w2ui-selected")
        .data("selected", "yes")
        .find(".w2ui-col-number")
  ...
  // all selected?
  var areAllSelected =
      this.records.length > 0 && sel.indexes.length == this.records.length,
    areAllSearchedSelected =
      sel.indexes.length > 0 &&
      this.searchData.length !== 0 &&
      sel.indexes.length == this.last.searchIds.length;
...
function unselectFunction() {
  ...
  for (var a = 0; a < arguments.length; a++) {
    ...
    recEl1
      ...
      .removeClass("w2ui-inactive")
      .removeData("selected")
      .find(".w2ui-col-number")
      .removeClass("w2ui-row-selected");
    recEl2
      .removeClass("w2ui-selected")
      .removeClass("w2ui-inactive")
      .removeData("selected")
      ...
      .removeClass("w2ui-row-selected");
    if (recEl1.length != 0) {
      recEl1[0].style.cssText =
        "height: " + this.recordHeight + "px; " + recEl1.attr("custom_style");
      recEl2[0].style.cssText =
        "height: " + this.recordHeight + "px; " + recEl2.attr("custom_style");
    }
